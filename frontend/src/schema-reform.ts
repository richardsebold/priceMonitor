...
export type ReformValues = z.infer<typeof reformSchema>;

export const signupReformSchema = z.object({
...
export type SignupReformValues = z.infer<typeof signupReformSchema>;